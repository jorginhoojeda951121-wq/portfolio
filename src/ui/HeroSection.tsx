        ...
        <div className="flex lg:flex-row flex-col  justify-center px-4 py-10 lg:px-6">
          <div className="flex flex-col justify-center px-4 py-10 lg:z-40 ">
            ...
            <p className="mt-5  text-base font-medium lg:w-4/5">
              ...
              in Back-End development with Node.js, Front-End development
              with React.js and Blockchain development. I have worked on various projects, including a Real{" "}
            ...
            <div className="mt-5">
              <div className="flex mt-5 gap-x-2 border-white border-collapse rounded">
                <Link
                  href="../../adrian-chan.pdf"
                  target="_blank"
                  download="full_stack_developer_resume_of_adrian.pdf"
                >
